 ...
 *Output  :  None
 ===============================================================================
 */
static const INT8U LoRa_DataRate_Table[6][3] = { { 7, 12, 1 }, //0.3kbps,       BW: 125KHz, Spreading Factor: 12, Error Coding value: 4/5,
...
//	{ 9, 11, 1 },   //2.4kbps, 	     BW: 500KHz, Spreading Factor: 11, Error Coding value: 4/5,
        { 8, 8, 1 }, //2.4kbps,       BW: 250KHz, Spreading Factor: 8, Error Coding value: 4/5,
...
INT8U RegsTable2[] =          //0x1D -  0x24
        ...
        DEF_LR_MODEMCONFIG1, //Disables the Implicit Header mode, Bw125kHz, CRC4/5
                DEF_LR_MODEMCONFIG2 | 0x04,  // CRC on, SymbTimeout(9:8) 11b
                0x05, //	DEF_LR_SYMBTIMEOUTLSB | 0xff,  // SymbTimeout(7:0) 0xff
                DEF_LR_PREAMBLEMSB,
...
//		SX1276_LoRa_SetPayloadLength( size );
    ...
    DEF_LR_DIOMAPPING1 | RFLR_DIOMAPPING1_DIO0_01  //TxDone
    ...
    DEF_LR_DIOMAPPING2 | RFLR_DIOMAPPING2_DIO4_01  //PllLock
            | RFLR_DIOMAPPING2_DIO5_00);  //Mode Ready
    SX1276_SetSwitchTx();
    SX1276_LoRa_SetMode(LORA_MODE_TX);

    /*
     while( ! SX1276_READ_DIO0( ) );
...
void SX1276_LoRa_StartRx(void)
{
    ...
    SX1276_WriteReg(
    REG_LR_IRQFLAGSMASK,
            DEF_LR_IRQFLAGSMASK | RFLR_IRQFLAGS_RXTIMEOUT
    ...
    /* Rx continuous model */
    SX1276_WriteReg( REG_LR_FIFOADDRPTR,
            SX1276_ReadReg( REG_LR_FIFORXBASEADDR)); // Set FifoAddrPtr to FifoRxBaseAddr
    SX1276_SetSwitchRx();
...
//	{
    ...
    if ((SX1276_ReadReg( REG_LR_IRQFLAGS) & RFLR_IRQFLAGS_PAYLOADCRCERROR)
            == RFLR_IRQFLAGS_PAYLOADCRCERROR) {
...
{
//    PRINTF("SX1276_LoRa_GetRxPacket\r\n");
...
//        SX1276_LoRa_FlushFifo( );
    ...
    SX1276_WriteReg( REG_LR_FIFOADDRPTR,
            SX1276_ReadReg( REG_LR_FIFORXCURRENTADDR));
//    SX1276_WriteReg( REG_LR_FIFOADDRPTR, SX1276_ReadReg( REG_LR_FIFORXBASEADDR ) );
     ...
     */
    SX1276_ReadFifoBuffer(buffer, size);
//	SX1276_LoRa_FlushFifo( );
