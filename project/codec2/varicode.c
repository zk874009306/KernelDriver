...
void test_varicode(int code_num) {
    ...
    //length = 10;
    ascii_in = (char*)CODEC2_MALLOC(length);
    varicode = (short*)CODEC2_MALLOC(VARICODE_MAX_BITS*sizeof(short)*length);
    ascii_out = (char*)CODEC2_MALLOC(length);
    ...
    CODEC2_FREE(ascii_in);
    CODEC2_FREE(ascii_out);
    CODEC2_FREE(varicode);
}
